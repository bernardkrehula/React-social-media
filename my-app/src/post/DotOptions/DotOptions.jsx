...
const DotOptions = ({postId, commentId, variation, displayOptions, isCommentByUser, optionsDisplayed, saveEditPostChanges, deletePost, enableCommentEditing, activateOptions, isCommentDisabled, deleteComment}) => {
