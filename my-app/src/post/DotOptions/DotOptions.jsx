...
const DotOptions = ({postId, commentId, manageEditComment, variation, enablePostEditing, displayOptions, isCommentByUser, optionsDisplayed, deletePost, enableCommentEditing, activateOptions, isCommentDisabled, deleteComment}) => {
        ...
        <>
            <div className={`post-dots ${variation}`} onClick={() => {
                ...
                if(activateOptions) activateOptions();
                        ...
                        if(enablePostEditing) enablePostEditing()
                        if(enableCommentEditing) enableCommentEditing()
                        if(!isCommentDisabled) manageEditComment()
                    }
                }>
                ...
                <div className='dotBtns' onClick={() => {
                            ...
                            if(deleteComment) deleteComment(postId, commentId);
                        }}>
