...
const Comment = ({comment, editComment, setNewComment, deleteComment }) => {
    ...
    return(
        <div className='comment'>
            ...
            <div className='comment-info'>
                ...
                <SearchBar placeholder={content} disabled={isCommentDisabled} setNewComment={setNewComment} setCurrentContent={setCurrentContent}/>
            </div>
