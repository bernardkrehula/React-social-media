...
const DotOptions = ({id, variation, optionsDisplayed, editPost, deletePost, setCommentDisabled, activateOptions, isCommentDisabled, editComment, deleteComment}) => {
        ...
        <>
            <div className={`post-dots ${variation}`} onClick={() => {
                ...
                <div className='dotBtns'  onClick={() => {
                    ...
                    <h2 className='dotsBtn' onClick={() => editComment(id)}>{isCommentDisabled || optionsDisplayed ? 'Edit' : 'Save'}</h2>
                </div>
